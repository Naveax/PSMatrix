...
def build(
    ...
    if present < 41:
        ...
        next_action = "Run the exact-head clean-tree repository private-material scan after final docs/cleanup and require zero findings."
