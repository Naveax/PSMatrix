...
class FinalProductionBootstrapContractTests(unittest.TestCase):
    ...
    def test_frozen_source_and_default_branch_identities_are_exact(self) -> None:
        ...
        self.assertEqual(value["execution_control_head"], "49080a038bcf02ea328d862904e43af4fcf540db")
        self.assertEqual(value["readiness_source_head"], "6bfedb4979d0832daf01f3f452144f7bb7f830d6")
