...
class FinalGAEvaluatorContentClosureHandoffTests(unittest.TestCase):
    def run_handoff(self, ready: dict[str, object], verified: dict[str, object], closure: dict[str, object]) -> subprocess.CompletedProcess[str]:
    ...
    def test_verified_readiness_and_exact_content_closure_reach_dry_run_dispatch(self) -> None:
    ...
    def test_source_uses_named_splatting_and_only_final_evaluator_workflow(self) -> None:
